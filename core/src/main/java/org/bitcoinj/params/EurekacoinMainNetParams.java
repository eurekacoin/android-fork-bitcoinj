...
public class EurekacoinMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public EurekacoinMainNetParams() {
        super();
        interval = INTERVAL;
        targetTimespan = TARGET_TIMESPAN;
        maxTarget = Utils.decodeCompactBits(0x1d00ffffL);
        dumpedPrivateKeyHeader = 58;
        addressHeader = 33;
        p2shHeader = 35;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 8333;
        packetMagic = 0xf1cfa6d3L; // x
        bip32HeaderPub = 0x0489E4AD; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x04891EB2; //The 4 byte header that serializes in base58 to "xprv"
    ...
    private static EurekacoinMainNetParams instance;
    public static synchronized EurekacoinMainNetParams get() {
        if (instance == null) {
            instance = new EurekacoinMainNetParams();
        }
        return instance;
    }
