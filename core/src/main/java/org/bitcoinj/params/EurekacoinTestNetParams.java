...
public class EurekacoinTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public EurekacoinTestNetParams() {
        super();
        interval = INTERVAL;
        targetTimespan = TARGET_TIMESPAN;
        maxTarget = Utils.decodeCompactBits(0x1d00ffffL);
        dumpedPrivateKeyHeader = 120;
        addressHeader = 93;
        p2shHeader = 95;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 8333;
        packetMagic = 0x0d221506L;
        bip32HeaderPub = 0x04339483; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x0433CF87; //The 4 byte header that serializes in base58 to "xprv"
    ...
    private static EurekacoinTestNetParams instance;
    public static synchronized EurekacoinTestNetParams get() {
        if (instance == null) {
            instance = new EurekacoinTestNetParams();
        }
        return instance;
    }
